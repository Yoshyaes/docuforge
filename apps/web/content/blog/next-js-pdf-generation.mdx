...
- Read the [full SDK documentation](https://fred-7da601c6.mintlify.app)
- Explore [pre-built templates](https://app.getdocuforge.dev/templates/gallery)
- Learn about [batch PDF generation](https://fred-7da601c6.mintlify.app/api-reference/generate) for high-volume use cases
