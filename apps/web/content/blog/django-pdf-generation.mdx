...
- Read the [Django guide](https://fred-7da601c6.mintlify.app/guides/django)
- Explore [template management](https://fred-7da601c6.mintlify.app/api-reference/templates)
- Set up a [Django management command](https://fred-7da601c6.mintlify.app) for batch report generation
