...
- Read the [Django guide](https://getdocuforge.dev/docs/guides/django)
- Explore [template management](https://getdocuforge.dev/docs/api-reference/templates)
- Set up a [Django management command](https://getdocuforge.dev/docs) for batch report generation
