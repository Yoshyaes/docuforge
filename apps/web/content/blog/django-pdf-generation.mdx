...
- Read the [Django guide](https://docs.docuforge.dev/guides/django)
- Explore [template management](https://docs.docuforge.dev/api-reference/templates)
- Set up a [Django management command](https://docs.docuforge.dev) for batch report generation
