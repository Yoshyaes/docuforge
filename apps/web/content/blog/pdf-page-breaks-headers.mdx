...
- Explore the [Page component API](https://docs.getdocuforge.dev)
- Learn about [watermarks](https://docs.getdocuforge.dev) for draft documents
- Read about [QR codes and barcodes](https://docs.getdocuforge.dev) in PDFs
