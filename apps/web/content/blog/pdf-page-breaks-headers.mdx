...
- Explore the [Page component API](https://getdocuforge.dev/docs)
- Learn about [watermarks](https://getdocuforge.dev/docs) for draft documents
- Read about [QR codes and barcodes](https://getdocuforge.dev/docs) in PDFs
