...
- Explore the [Page component API](https://fred-7da601c6.mintlify.app)
- Learn about [watermarks](https://fred-7da601c6.mintlify.app) for draft documents
- Read about [QR codes and barcodes](https://fred-7da601c6.mintlify.app) in PDFs
