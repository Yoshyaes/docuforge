...
- Read the [Python SDK docs](https://fred-7da601c6.mintlify.app)
- Explore [Django integration](https://fred-7da601c6.mintlify.app/guides/django)
- Try [batch generation](https://fred-7da601c6.mintlify.app/api-reference/generate) for bulk reports
