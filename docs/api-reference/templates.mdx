...
`POST https://api.docuforge.dev/v1/templates`

```bash
curl -X POST https://api.docuforge.dev/v1/templates \
...
`GET https://api.docuforge.dev/v1/templates`

## Get a Template

`GET https://api.docuforge.dev/v1/templates/:id`

## Update a Template

`PUT https://api.docuforge.dev/v1/templates/:id`

Updates increment the `version` field when `html_content` changes.

## Delete a Template

`DELETE https://api.docuforge.dev/v1/templates/:id`
