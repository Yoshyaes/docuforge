...
- **[Automate Stripe invoices](/blog/invoice-system-stripe-docuforge)** -- Generate PDF invoices on every successful Stripe payment and email them to customers.
- **[Generate PDFs in Next.js](/blog/generate-pdfs-nextjs-docuforge)** -- Build a dashboard front end that lets users trigger report generation on demand.
- **[Page layout guide](/blog/pdf-page-breaks-headers-footers-guide)** -- Fine-tune margins, headers, footers, and multi-page layouts for professional documents.

Check out the [full API reference](/docs/api-reference) for additional features like PDF merging, splitting, password protection, and form filling.
