...
- **[Automate Stripe invoices](/blog/automate-stripe-invoices-pdf)** -- Generate PDF invoices on every successful Stripe payment and email them to customers.
...
- **[Page layout guide](/docs/page-layout)** -- Fine-tune margins, headers, footers, and multi-page layouts for professional documents.
