...
For teams building a full SaaS billing portal, the [Next.js integration guide](https://getdocuforge.dev/docs/guides/nextjs) shows how to add a customer-facing invoice history page with on-demand PDF regeneration.
