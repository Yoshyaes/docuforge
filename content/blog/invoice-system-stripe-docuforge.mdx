...
For **reporting**, look at our guide on [generating Supabase reports with DocuForge](/blog/generate-report-pdfs-supabase-data) -- the same template and batch patterns apply to monthly financial summaries.

If you want more control over **page layout** -- custom headers per page, landscape tables, or page break control -- the [page layout and headers guide](/blog/pdf-page-breaks-headers-footers-guide) covers all the options available in the `PDFOptions` object.

For teams building a full SaaS billing portal, the [Next.js integration guide](/docs/guides/nextjs) shows how to add a customer-facing invoice history page with on-demand PDF regeneration.
