...
For teams building a full SaaS billing portal, the [Next.js integration guide](https://fred-7da601c6.mintlify.app/guides/nextjs) shows how to add a customer-facing invoice history page with on-demand PDF regeneration.
