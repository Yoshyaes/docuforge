...
- **Django integration** -- If your project uses Django rather than FastAPI, the SDK works identically. See our [Django tutorial](https://getdocuforge.dev/blog/django-pdf-generation-made-simple) for middleware patterns and class-based view examples.
...
- **Page layout control** -- Our [page layout guide](https://getdocuforge.dev/blog/pdf-page-breaks-headers-footers-guide) covers headers, footers, page numbers, and multi-column layouts in detail.
- **Comparison with local rendering** -- If you are evaluating DocuForge against Puppeteer or WeasyPrint, the [DocuForge vs Puppeteer](https://getdocuforge.dev/blog/docuforge-vs-puppeteer-why-i-switched) article breaks down the trade-offs in performance, accuracy, and operational overhead.
