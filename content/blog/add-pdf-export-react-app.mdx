...
- **[Generating PDFs in Next.js with Server Actions](/blog/generate-pdfs-nextjs-docuforge)** -- deeper integration with the App Router and Server Actions pattern.
- **[Page Layout and Multi-Page Documents](/blog/pdf-page-breaks-headers-footers-guide)** -- advanced control over page breaks, headers that repeat across pages, and landscape orientation.
