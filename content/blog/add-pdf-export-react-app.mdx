...
- **[Generating PDFs in Next.js with Server Actions](/blog/generate-pdfs-nextjs)** -- deeper integration with the App Router and Server Actions pattern.
- **[Page Layout and Multi-Page Documents](/blog/page-layout-multi-page-pdfs)** -- advanced control over page breaks, headers that repeat across pages, and landscape orientation.
...
Check out the [DocuForge documentation](https://docs.docuforge.com) for the full API reference and more examples.
